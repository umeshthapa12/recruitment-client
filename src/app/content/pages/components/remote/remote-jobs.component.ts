...
@Component({
	selector: 'remote-jobs',
	templateUrl: './remote-jobs.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	styleUrls: ['../shared-styles.scss']
})
export class RemoteJobsComponent  extends JobListActionBase implements OnDestroy, AfterViewInit {
	...
	constructor(
		...
		const d = { content: 'Remote Jobs', contentRef: ContentRef.List };
	...
	private initList = () => {
		...
		this.jobService.getJobLists(this.query, JobTypeRouteEnums.RT, this.searchInputCtrl.value, null).pipe(
