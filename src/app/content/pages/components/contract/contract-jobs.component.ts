...
import { JobTypeRouteEnums, QueryModel } from '../../../../models';
...
@Component({
	selector: 'contract-jobs',
	templateUrl: './contract-jobs.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	styleUrls: ['../shared-styles.scss']
})
export class ContractJobsComponent extends JobListActionBase implements OnDestroy, AfterViewInit {
	...
	constructor(
		...
		const d = { content: 'Contract Jobs', contentRef: ContentRef.List };
	...
	private initList = () => {
		...
		this.jobService.getJobLists(this.query, JobTypeRouteEnums.CT, this.searchInputCtrl.value, null).pipe(
