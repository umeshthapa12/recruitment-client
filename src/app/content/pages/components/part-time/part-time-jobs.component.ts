...
@Component({
	selector: 'part-time-jobs',
	templateUrl: './part-time-jobs.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	styleUrls: ['../shared-styles.scss']
})
export class PartTimeJobsComponent extends JobListActionBase implements OnDestroy, AfterViewInit {
	...
	constructor(
		...
		const d = { content: 'Part-time Jobs', contentRef: ContentRef.List };
	...
	private initList = () => {
		...
		this.jobService.getJobLists(this.query, JobTypeRouteEnums.PT, this.searchInputCtrl.value, null).pipe(
