...
export class InternshipComponent extends JobListActionBase implements OnDestroy, AfterViewInit {
	...
	constructor(
		...
		const d = { content: 'Internship Jobs', contentRef: ContentRef.List };
	...
	private initList = () => {
		...
		this.jobService.getJobLists(this.query, JobTypeRouteEnums.INT, this.searchInputCtrl.value, null).pipe(
