...
@NgModule({
    imports: [CommonModule, FormsModule, ReactiveFormsModule, MatCardModule, MatFormFieldModule, MatTooltipModule, MatDialogModule, MatInputModule, MatDividerModule, MatCardPlaceholderModule,
    ...
    providers: [EmployerServiceProvidorService]
})
